...
def index(request):
    ...
    #     # id =
    #     # update = update_massage.objects.get(stu_id=student.student_id)s
    #     # gratuate = gratudated_and_employ.objects.get(stu_id=student.student_id)
    #     # famliy = parents.objects.get(stu_id=student.student_id)
    #
